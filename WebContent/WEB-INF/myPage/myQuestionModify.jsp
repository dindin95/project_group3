	...
	<div class="container">
			<form method="post" action="myQuestionModifyResult.do">
				...
				<table class="table table-striped" style="text-align: center; border: 1px solid #dddddd">
						<tr>
							<td><input type="text" name="q_no"  style="border:none; background:transparent; text-align:right" size=2  readonly="readonly" value="<%=dto.getQ_no() %>"></td>
							<td><input type="text" class="form-control" name="q_title" id="q_title" maxlength="50" required="required" value="<%=dto.getQ_title() %>" ></td>
							<td><input type="text" name="m_id"  style="border:none; background:transparent; text-align:right" size=2   readonly="readonly" value="<%=dto.getM_id() %>">님</td>
						</tr>
				</table>
